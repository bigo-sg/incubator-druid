...
public class HiveCompactionTask extends AbstractTask
{
  private static final Logger log = new Logger(HiveCompactionTask.class);
  private static final String TYPE = "hvie_compact";
...
//                                                 : convertToCombiningFactories(metricsSpec);
  ...
  public static class Builder
  {
    ...
    public HiveCompactionTask build()
    {
      return new HiveCompactionTask(
          null,
          null,
          dataSource,
          interval,
