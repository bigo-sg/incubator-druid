...
export class CompactionView extends React.Component<CompactionViewProps, CompactionViewState> {
  ...
  renderCompactionTable() {
    ...
    return (
      <ReactTable
        ...
        noDataText={
          !compactionLoading && compaction && !compaction.length
            ? 'No compaction'
            : compactionError || ''
        }
        filterable
  ...
  render() {
    ...
    return (
      <div className="compaction-view app-view">
        <div className="control-bar">
          <div className="control-label">Compaction</div>
          <div className="extra-info">
            <span>
              compactionTaskSlotRatio(<b>{compactionTaskSlotRatio}</b>)
            </span>
            <span>
              maxCompactionTaskSlots(<b>{maxCompactionTaskSlots}</b>)
            </span>
          </div>
        </div>
